...
export const projects: Project[] = [
  {
    ...
    detailedContent: {
      overview: [
        'Minim4You sells the **Four Species for Sukkot**. It is a business that does almost all of its year in a few weeks, and its customers would rather send a WhatsApp message than open a website. This system lets them **shop without leaving the chat**. It is **live in production**: a `Spring Boot` service on Heroku that sits between the **official Meta WhatsApp Business API** and the store\'s **Wix** catalogue, carts, orders and CRM.',
